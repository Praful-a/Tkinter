...
def edit():
    ...
    # Create Global Varialbles for text box names
    ...
    zipcode_label.grid(row=5, column=0, pady=5)
    ...
    update_btn.grid(row=6, column=0, columnspan=2, pady=10, padx=10, ipadx=131)
...
delete_box_lable = Label(root, text="Select ID")
delete_box_lable.grid(row=9, column=0)

# Create Submit Button
submit_btn = Button(root, text="Add Record To Database", command=submit)
submit_btn.grid(row=6, column=0, columnspan=2, pady=20, padx=10, ipadx=100)
...
update_btn.grid(row=11, column=0, columnspan=2, pady=10, padx=10, ipadx=131)
